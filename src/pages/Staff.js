...
const Staff = () => {
  ...
  const handleSave = () => {
    if (selectedStaff) {
      setStaff(
        staff.map((emp) => (emp.id === selectedStaff.id ? formData : emp))
      );
      setSelectedStaff(null);
    } else {
